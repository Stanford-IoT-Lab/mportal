...
module.exports = new lang.Class({
    ...
    _init: function(flushOnly) {
        instance_ = this;

        this._conversations = {};
        this._patients = {};
        this._flushOnly = flushOnly;
    ...
    _makeConversation: function(feedId) {
        ...
        return feed.open().then(function() {
            ...
            var patient = this._patients[members[1].account];
            if (!patient) {
                patient = new Patient(members[1], this._doctorPortal);
                this._patients[members[1].account] = patient;
            }

            var conv = new Conversation(this._client, this._sempre, feed, members[1], patient, this._doctorPortal);
