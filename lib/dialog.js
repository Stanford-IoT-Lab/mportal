...
const ShareDialog = new lang.Class({
    ...
    _execute: function() {
        return this.manager.patient.withTransaction(function() {
            return this.manager.patient.exportRecords().then(function(records) {
                return this.manager.patient.getInfo().then(function(patientInfo) {
                    return this.manager.doctorPortal.syncPatient(this.manager.user.account, patientInfo, records);
                }.bind(this)).then(function(patientId) {
                    return this.manager.doctorPortal.addPatientToDoctor(patientId, this.doctorId);
                }.bind(this));
            }.bind(this));
