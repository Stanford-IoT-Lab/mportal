...
const InsertValueDialog = new lang.Class({
    ...
    _askValue: function() {
        if (this.kind === 'weight')
            ...
            return this.ask(ValueCategory.Measure('m'), "What is your heart rate?");
        else if (this.kind === 'blood_pressure')
            return this.ask(ValueCategory.Measure('m'), "What is your blood pressure?");
